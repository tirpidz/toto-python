...
blue "🛸 Checking Code Formating ..."
black ${TOTO_REPO_ROOT}/toto --check
isort ${TOTO_REPO_ROOT}/toto --check
purple "💫 Checking Code Formating done."

blue "🛸 Code Analysis ..."
flake8 --config ${TOTO_REPO_ROOT}/config.cfg ./toto
purple "💫 Code Analysis done"